# Contributing to `phionyx-eval`

`phionyx-eval` is an LLM-as-judge evaluation primitive with deterministic verdict derivation. It is **alpha / experimental**. Contributions, independent
